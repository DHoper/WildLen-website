...
import type { AuthorDataType, CommunityPostType, DialogType } from "@/types";
...
<template>
  <div v-if="formData && authorData"
    ...
    <div class="mt-12 mx-auto border-2 border-stone-800 w-[62rem] max-w-full px-24 py-16">
      ...
      <div v-if="formData.images && formData.images.length > 0" class="mt-20 border-2 border-stone-700">
      ...
      <div class="flex justify-between">
        ...
        <span class="group flex items-center gap-1 2xl:text-xl hover:cursor-pointer focus:text-red-500 transition-all"
          tabindex="0">
    ...
    <div class="flex gap-16 text-xl">
      <button @click="handleSubmit" :disabled="isSubmitting" class="text-white px-6 py-2 border-2 border-transparent"
