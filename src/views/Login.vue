    ...
    <div class="min-w-fit flex justify-between items-center w-screen h-full">
      ...
      <div class="relative h-full basis-2/5 bg-stone-800 bg-opacity-40 flex flex-col justify-center items-center">
        ...
        <div class="text-white flex flex-col justify-center items-center gap-6">
          <div class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800" :class="loginIsFailed === LoginStatus.EmailError
            ? 'border-red-500'
            : 'border-transparent'
            ">
            <div class="border-b-2 border-stone-300 flex items-center gap-2 w-full py-1 2xl:px-2">
              ...
              <input id="username" v-model="email"
                class="focus:ring-0 focus:outline-none bg-transparent max-w-52 text-sm 2xl:text-base" type="text"
                name="username" required autocomplete="autocomplete_off">
            </div>
          </div>
          <div class="border mb-3 text-center flex flex-col w-full bg-[#d1d1d1] px-2 py-1 text-stone-800" :class="loginIsFailed === LoginStatus.PasswordError
            ? 'border-red-500'
            : 'border-transparent'
            ">
            <div class="border-b-2 border-stone-300 flex gap-2 py-1 2xl:px-2">
              ...
              <input id="password" v-model="password"
                class="focus:ring-0 focus:outline-none bg-transparent max-w-52 text-sm 2xl:text-base" type="password"
                name="password" required autocomplete="autocomplete_off">
            </div>
          </div>
          <button type="button"
